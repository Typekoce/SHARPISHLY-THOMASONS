...
/**
 * Standalone HotmailapiController (Microsoft Graph API)
 * Handles OAuth2 flow and endpoint interaction within a single class.
 */
class HotmailapiController extends BaseController
{
    /**
     * Entry point: Fetches user profile data from Microsoft Graph.
     */
    public function index()
    {
        ...
        // Microsoft Graph endpoint replaces the Google userinfo endpoint
     ...
     * Trigger: /hotmail-auth/callback?code=...
     */
    public function callback()
    {
        ...
        $params = [
            ...
            'client_secret' => HOTMAIL_CLIENT_SECRET,
    ...
    {
        $path = $this->loc->storage('hotmail/tokens/access_token.txt');
