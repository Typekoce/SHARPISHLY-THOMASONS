	...
	function initJSandCSS() {
		echo <<<SCRIPTS
			...
			<style type="text/css">
				...
				/* array */
				table.dBug_array { background-color:#006600; border:1px solid green;}
				table.dBug_array td { background-color:#FFFFFF; border:1px solid green;}
				table.dBug_array td.dBug_arrayHeader { background-color:#009900; border:1px solid green;}
				table.dBug_array td.dBug_arrayKey { background-color:#CCFFCC; border:1px solid green;}
				
				/* object */
				table.dBug_object { background-color:#0000CC; border:1px solid blue;}
				table.dBug_object td { background-color:#FFFFFF; border:1px solid blue;}
				table.dBug_object td.dBug_objectHeader { background-color:#4444CC; border:1px solid blue;}
				table.dBug_object td.dBug_objectKey { background-color:#CCDDFF; border:1px solid blue;}
